 ...
 * MA  02110-1301, USA.
 */
package org.switchyard.component.camel.common.processor;
...
public class CxfRsHttpDynamicProcessor extends DefaultProcessor {
    ...
    public void process(Exchange camelExchange) throws Exception {
        ...
        camelExchange.getIn().setHeader(CamelConstants.CAMEL_CXF_RS_USING_HTTP_API, Boolean.TRUE);
        camelExchange.getIn().setHeader(CamelConstants.CAMEL_CXF_RS_RESPONSE_CLASS, restMethod.getResponseType());
