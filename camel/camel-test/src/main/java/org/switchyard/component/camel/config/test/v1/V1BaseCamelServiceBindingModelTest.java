 ...
 *
 * @param <T> Type of the camel binding model.
 */
public abstract class V1BaseCamelServiceBindingModelTest<T extends V1BaseCamelBindingModel, E extends Endpoint> extends V1BaseCamelModelTest<T> {
    ...
    protected Class<E> _endpointType;
    protected boolean _skipCamelEndpointTesting;

    public V1BaseCamelServiceBindingModelTest(Class<E> endpointType, String fileName, boolean valid) {
        _endpointType = endpointType;
        _fileName = fileName;
        _valid = valid;
    }

    public V1BaseCamelServiceBindingModelTest(Class<E> endpointType, String fileName) {
